...
import io.github.dsheirer.sample.buffer.INativeSampleDelayBuffer;
...
public class HeterodyneChannelSourceManager extends ChannelSourceManager
{
    ...
    private INativeSampleDelayBuffer mSampleDelayBuffer;
    ...
    private void startDelayBuffer()
    {
        if(mSampleDelayBuffer == null)
        {
            ...
            mSampleDelayBuffer = new INativeSampleDelayBuffer(delayBufferSize, mTunerController.getBufferDuration());
