...
import io.github.dsheirer.sample.buffer.InterleavedComplexSamplesDelayBuffer;
...
public class HeterodyneChannelSourceManager extends ChannelSourceManager
{
    ...
    private InterleavedComplexSamplesDelayBuffer mSampleDelayBuffer;
    ...
    private void startDelayBuffer()
    {
        if(mSampleDelayBuffer == null)
        {
            ...
            mSampleDelayBuffer = new InterleavedComplexSamplesDelayBuffer(delayBufferSize, mTunerController.getBufferDuration());
