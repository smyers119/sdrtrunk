...
public interface IRealOscillator
{
    /**
    ...
    /**
     * Generates a mixing buffer of samples and mixes/multiplies the samples with the buffer
     * @param samples to mix with a buffer of samples generated by this oscillator
     * @return
     */
    float[] mix(float[] samples);
}
