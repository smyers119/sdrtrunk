 ...
 *
 * This filter can be used for any tap length and uses SIMD 512-bit/16-lane instructions.
 */
public class VectorRealHalfBandDecimationFilter512Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter512Bit(float[] coefficients)
    {
