 ...
 *
 * This filter is optimized for an 63-tap half band filter running on a CPU that supports 128-bit/4-lane floating
 * point SIMD instructions.
 */
public class VectorRealHalfBandDecimationFilter63Tap128Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter63Tap128Bit(float[] coefficients)
    {
