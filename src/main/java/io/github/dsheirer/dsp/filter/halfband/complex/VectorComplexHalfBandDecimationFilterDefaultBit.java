 ...
 *
 * This filter can be used for any combination of tap length and SIMD lane lengths.
 */
public class VectorComplexHalfBandDecimationFilterDefaultBit implements IComplexDecimationFilter
{
     ...
     */
    public VectorComplexHalfBandDecimationFilterDefaultBit(float[] coefficients)
    {
