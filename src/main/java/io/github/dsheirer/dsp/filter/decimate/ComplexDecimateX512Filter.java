...
public class ComplexDecimateX512Filter extends ComplexDecimateX256Filter
{
    ...
    private static final WindowType DECIMATE_BY_512_WINDOW_TYPE = WindowType.BLACKMAN;
    ...
    {
        mFilter = FilterFactory.getComplexDecimationFilter(DECIMATE_BY_512_FILTER_LENGTH,
