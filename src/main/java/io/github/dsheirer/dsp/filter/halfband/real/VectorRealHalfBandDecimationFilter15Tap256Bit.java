 ...
 *
 * This filter is optimized for an 15-tap half band filter running on a CPU that supports 256-bit/8-lane floating
 * point SIMD instructions.
 */
public class VectorRealHalfBandDecimationFilter15Tap256Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter15Tap256Bit(float[] coefficients)
    {
