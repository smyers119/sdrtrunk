 ...
 *
 * This filter is optimized for an 63-tap half band filter running on a CPU that supports 256-bit/8-lane floating
 * point SIMD instructions.
 */
public class VectorRealHalfBandDecimationFilter63Tap256Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter63Tap256Bit(float[] coefficients)
    {
