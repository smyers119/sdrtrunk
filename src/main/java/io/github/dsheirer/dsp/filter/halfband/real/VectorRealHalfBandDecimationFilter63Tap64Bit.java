 ...
 *
 * This filter is optimized for an 63-tap half band filter running on a CPU that supports 64-bit/2-lane floating
 * point SIMD instructions.
 */
public class VectorRealHalfBandDecimationFilter63Tap64Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter63Tap64Bit(float[] coefficients)
    {
