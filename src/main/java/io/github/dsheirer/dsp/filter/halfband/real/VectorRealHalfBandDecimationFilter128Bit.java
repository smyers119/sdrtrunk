 ...
 *
 * This filter can be used for any tap length and uses SIMD 128-bit/4-lane instructions.
 */
public class VectorRealHalfBandDecimationFilter128Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter128Bit(float[] coefficients)
    {
