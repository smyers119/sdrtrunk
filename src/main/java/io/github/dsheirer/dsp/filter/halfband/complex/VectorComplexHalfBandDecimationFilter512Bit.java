 ...
 *
 * This filter can be used for any combination of tap length with a 512-bit/16-lane SIMD instructions.
 */
public class VectorComplexHalfBandDecimationFilter512Bit implements IComplexDecimationFilter
{
     ...
     */
    public VectorComplexHalfBandDecimationFilter512Bit(float[] coefficients)
    {
