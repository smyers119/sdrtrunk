 ...
 *
 * This filter can be used for any tap length and uses SIMD 256-bit/8-lane instructions.
 */
public class VectorRealHalfBandDecimationFilter256Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter256Bit(float[] coefficients)
    {
