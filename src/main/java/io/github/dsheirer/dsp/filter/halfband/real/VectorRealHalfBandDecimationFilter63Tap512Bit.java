 ...
 *
 * This filter is optimized for an 63-tap half band filter running on a CPU that supports 512-bit/16-lane floating
 * point SIMD instructions.
 */
public class VectorRealHalfBandDecimationFilter63Tap512Bit implements IRealDecimationFilter
{
