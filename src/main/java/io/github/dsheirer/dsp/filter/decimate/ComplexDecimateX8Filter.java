...
public class ComplexDecimateX8Filter extends ComplexDecimateX4Filter
{
    ...
    private static final WindowType DECIMATE_BY_8_WINDOW_TYPE = WindowType.BLACKMAN;
    ...
    {
        mFilter = FilterFactory.getComplexDecimationFilter(DECIMATE_BY_8_FILTER_LENGTH,
