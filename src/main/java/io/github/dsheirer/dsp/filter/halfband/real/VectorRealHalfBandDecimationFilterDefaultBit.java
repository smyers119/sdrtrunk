 ...
 */
public class VectorRealHalfBandDecimationFilterDefaultBit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilterDefaultBit(float[] coefficients)
    {
