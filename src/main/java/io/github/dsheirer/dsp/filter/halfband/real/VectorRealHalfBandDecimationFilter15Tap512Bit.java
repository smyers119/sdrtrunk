 ...
 *
 * This filter is optimized for an 15-tap half band filter running on a CPU that supports 512-bit/16-lane floating
 * point SIMD instructions.
 */
public class VectorRealHalfBandDecimationFilter15Tap512Bit implements IRealDecimationFilter
{
     ...
     */
    public VectorRealHalfBandDecimationFilter15Tap512Bit(float[] coefficients)
    {
