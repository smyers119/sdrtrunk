 ...
 */
public class VectorComplexHalfBandDecimationFilter15Tap512Bit implements IComplexDecimationFilter
{
    ...
    private float[] mCoefficient0_x_2_x_4_x_6_7 = new float[16];
    private float[] mCoefficientx_8_x_10_x_12_x_14 = new float[16];
     ...
     */
    public VectorComplexHalfBandDecimationFilter15Tap512Bit(float[] coefficients)
    {
        ...
        mCoefficient0_x_2_x_4_x_6_7[0] = coefficients[0];
        mCoefficient0_x_2_x_4_x_6_7[1] = coefficients[0];
        mCoefficient0_x_2_x_4_x_6_7[4] = coefficients[2];
        mCoefficient0_x_2_x_4_x_6_7[5] = coefficients[2];
        mCoefficient0_x_2_x_4_x_6_7[8] = coefficients[4];
        mCoefficient0_x_2_x_4_x_6_7[9] = coefficients[4];
        mCoefficient0_x_2_x_4_x_6_7[12] = coefficients[6];
        mCoefficient0_x_2_x_4_x_6_7[13] = coefficients[6];

        mCoefficient0_x_2_x_4_x_6_7[14] = coefficients[7]; //Center coefficient
        mCoefficient0_x_2_x_4_x_6_7[15] = coefficients[7];

        mCoefficientx_8_x_10_x_12_x_14[2] = coefficients[8];
        mCoefficientx_8_x_10_x_12_x_14[3] = coefficients[8];
        mCoefficientx_8_x_10_x_12_x_14[6] = coefficients[10];
        mCoefficientx_8_x_10_x_12_x_14[7] = coefficients[10];
        mCoefficientx_8_x_10_x_12_x_14[10] = coefficients[12];
        mCoefficientx_8_x_10_x_12_x_14[11] = coefficients[12];
        mCoefficientx_8_x_10_x_12_x_14[14] = coefficients[14];
        mCoefficientx_8_x_10_x_12_x_14[15] = coefficients[14];
    ...
    public float[] decimateComplex(float[] samples)
    {
        ...
        FloatVector filterA = FloatVector.fromArray(VECTOR_SPECIES, mCoefficient0_x_2_x_4_x_6_7, 0);
        FloatVector filterB = FloatVector.fromArray(VECTOR_SPECIES, mCoefficientx_8_x_10_x_12_x_14, 0);

        FloatVector fvA, fvB, accumulator;
        ...
        for(int bufferPointer = 0; bufferPointer < samples.length; bufferPointer += 4)
        {
            ...
            fvB = FloatVector.fromArray(VECTOR_SPECIES, mBuffer, bufferPointer + 14);

            accumulator = filterA.mul(fvA).add(filterB.mul(fvB));
