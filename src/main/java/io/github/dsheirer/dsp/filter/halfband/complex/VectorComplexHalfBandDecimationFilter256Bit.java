 ...
 *
 * This filter can be used for any combination of tap length with a 256-bit/8-lane SIMD instructions.
 */
public class VectorComplexHalfBandDecimationFilter256Bit implements IComplexDecimationFilter
{
     ...
     */
    public VectorComplexHalfBandDecimationFilter256Bit(float[] coefficients)
    {
