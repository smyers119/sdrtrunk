 ...
 *
 * This filter is optimized for an 11-tap half band filter running on a CPU that supports 128-bit/4-lane floating
 * point SIMD instructions.
 */
public class VectorRealHalfBandDecimationFilter11Tap128Bit implements IRealDecimationFilter
{
    ...
    private float[] mCoefficients = new float[12];
     ...
     */
    public VectorRealHalfBandDecimationFilter11Tap128Bit(float[] coefficients)
    {
