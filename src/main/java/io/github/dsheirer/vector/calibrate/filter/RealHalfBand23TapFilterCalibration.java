 ...
 */
public class RealHalfBand23TapFilterCalibration extends Calibration
{
    private static final Logger mLog = LoggerFactory.getLogger(RealHalfBand23TapFilterCalibration.class);
    ...
    public RealHalfBand23TapFilterCalibration()
    {
        ...
        mVector512 = new VectorRealHalfBandDecimationFilter23Tap512Bit(coefficients);
        mVector256 = new VectorRealHalfBandDecimationFilter23Tap256Bit(coefficients);
        mVector128 = new VectorRealHalfBandDecimationFilter23Tap128Bit(coefficients);
        mVector64 = new VectorRealHalfBandDecimationFilter23Tap64Bit(coefficients);
    }
    ...
    @Override public void calibrate() throws CalibrationException
    {
        ...
        mLog.info("REAL HALF-BAND 23-TAP DECIMATE - SET OPTIMAL IMPLEMENTATION TO: " + getImplementation());
    }
