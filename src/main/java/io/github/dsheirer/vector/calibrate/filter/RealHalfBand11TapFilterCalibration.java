 ...
 */
public class RealHalfBand11TapFilterCalibration extends Calibration
{
    private static final Logger mLog = LoggerFactory.getLogger(RealHalfBand11TapFilterCalibration.class);
    private static final VectorSpecies<Float> VECTOR_SPECIES = FloatVector.SPECIES_PREFERRED;
    private static final int BUFFER_SIZE = 2048;
    private static final int BUFFER_ITERATIONS = 10_000;
    ...
    {
        super(CalibrationType.FILTER_HALF_BAND_REAL_11_TAP);
        float[] coefficients = FilterFactory.getHalfBand(11, WindowType.BLACKMAN);
        mScalar = new RealHalfBandDecimationFilter(coefficients);
        mVector512 = new VectorRealHalfBandDecimationFilter11Tap512Bit(coefficients);
        mVector256 = new VectorRealHalfBandDecimationFilter11Tap256Bit(coefficients);
        mVector128 = new VectorRealHalfBandDecimationFilter11Tap128Bit(coefficients);
        mVector64 = new VectorRealHalfBandDecimationFilter11Tap64Bit(coefficients);
    }
    ...
    @Override public void calibrate() throws CalibrationException
    {
        ...
        mLog.info("REAL HALF-BAND 11-TAP DECIMATE WARMUP - SCALAR: " + DECIMAL_FORMAT.format(scalarMean.getResult()));
        ...
        if(VECTOR_SPECIES.length() >= 16)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE WARMUP - VECTOR 512: " + DECIMAL_FORMAT.format(vector512Mean.getResult()));
        }
        ...
        if(VECTOR_SPECIES.length() >= 8)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE WARMUP - VECTOR 256: " + DECIMAL_FORMAT.format(vector256Mean.getResult()));
        }
        ...
        if(VECTOR_SPECIES.length() >= 4)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE WARMUP - VECTOR 128: " + DECIMAL_FORMAT.format(vector128Mean.getResult()));
        }
        ...
        if(VECTOR_SPECIES.length() >= 2)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE WARMUP - VECTOR 64: " + DECIMAL_FORMAT.format(vector64Mean.getResult()));
        }
        ...
        mLog.info("REAL HALF-BAND 11-TAP DECIMATE - SCALAR: " + DECIMAL_FORMAT.format(scalarMean.getResult()));
        ...
        if(VECTOR_SPECIES.length() >= 16)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE - VECTOR 512: " + DECIMAL_FORMAT.format(vector512Mean.getResult()));
        ...
        if(VECTOR_SPECIES.length() >= 8)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE - VECTOR 256: " + DECIMAL_FORMAT.format(vector256Mean.getResult()));
        ...
        if(VECTOR_SPECIES.length() >= 4)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE - VECTOR 128: " + DECIMAL_FORMAT.format(vector128Mean.getResult()));
        ...
        if(VECTOR_SPECIES.length() >= 2)
        {
            ...
            mLog.info("REAL HALF-BAND 11-TAP DECIMATE - VECTOR 64: " + DECIMAL_FORMAT.format(vector64Mean.getResult()));
        ...
        mLog.info("REAL HALF-BAND 11-TAP DECIMATE - SET OPTIMAL IMPLEMENTATION TO: " + getImplementation());
    }
