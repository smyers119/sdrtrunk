 ...
 */
public class ComplexHalfBand11TapFilterCalibration extends ComplexHalfBandBaseFilterCalibration
{
     ...
     */
    public ComplexHalfBand11TapFilterCalibration()
    {
        super(CalibrationType.FILTER_HALF_BAND_COMPLEX_11_TAP, COEFFICIENT_LENGTH);
    }
